...
/*   Updated: 2024/05/02 15:53:28 by omar             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void init_and_draw_line(mlx_t *mlx, t_game *game)
{
	...
	game->player->line->img_line = mlx_new_image(mlx, game->player->line->length, game->player->line->length);
	...
	if (!game->player->line->img_line || (mlx_image_to_window(mlx,
															  ...
															  game->player->img_player->instances[0].x + game->player->line->img_line->width,
															  game->player->img_player->instances[0].y + game->player->line->img_line->height) == -1))
		return (printf("Error\n"), (void)NULL);
